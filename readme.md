...
+ [命令模式和主动对象模式(https://www.evernote.com/shard/s501/nl/176057404/2e5e3f34-52f5-4384-aa25-87422158d0a4/)
+ [模版方法模式和策略模式 分离通用算法与具体上下文](https://www.evernote.com/shard/s501/nl/176057404/806ee18b-e54a-44d1-81a4-08d8a1882724/) __ 解耦任务与执行策略__
