...
+ [命令模式和主动对象模式 解耦任务与执行策略](https://www.evernote.com/shard/s501/nl/176057404/2e5e3f34-52f5-4384-aa25-87422158d0a4/)
+ [模版方法模式和策略模式 分离通用算法与具体上下文](https://www.evernote.com/shard/s501/nl/176057404/806ee18b-e54a-44d1-81a4-08d8a1882724/)
+ [门面模式和中介者模式 对对象组施加策略](https://www.evernote.com/shard/s501/nl/176057404/13c55c28-0193-4cdc-bcd6-92cc28432f5d/)
+ [单例模式和单态模式 单一对象](https://www.evernote.com/shard/s501/nl/176057404/fc0c9d1f-482c-400a-8ed6-029d3507685a/)
+ 空对象模式 Java 8的Option类型可以替代该模式
